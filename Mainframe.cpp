...
void showMenu()
{
  ...
  //  cout << "\033[32m"; // Farbcode für grünen Text
    ...
    cout << "  \033[32m     | \\  / | __ _| |__ __ _ __   __  \033[0m |  | @---------------------' 14. Optionen '                |  |     " << endl;
    cout << "  \033[32m     | |\\/| |/ _` | __|'__| |\) ) / / \033[0m  |  |-------------------------------------------------------|  |     " << endl;
    cout << "   \033[32m    | |  | | (_| | | | | | |  >< /\033[0m    |__________________________________________________________|  /      " << endl;
    cout << "  \033[32m     |_|  |_|(__,_|_| |_| |_/_/ ]__) \033[0m    (__________________________________________________________/        " << endl;
